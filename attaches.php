				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Students</h3>
						</div>
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="employee-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
									        ...
									        print '<center><img class="img-circle autofit2" src="images/default.jpg" alt="image"  /></center>';
											    ...
											    <center><img class="autofit2" alt="image"  src="employee/<?php echo $empavatar ?>"/></center>
                                            <?php }
										    ?>
											...
											<div class="content">
												...
												<p class="location"><i class="fa fa-map-marker"></i> <?php echo $row['town'] ?></p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Ministry of labor provides easy access to jobs all over the town </p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Marondera, Zimbabwe PO.BOX 14859</p>
								<p>Email : <a href="">mlabor@jobs.com</a></p>
								<p>Phone : <a href="">00000000000</a></p>
