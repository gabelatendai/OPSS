...
<head>
	...
	<title>Ministry of labor Jobs - Login</title>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <div class="modal-header">
                                <h4 class="modal-title text-center">Enter details to manage your system</h4>
                                </div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Ministry of labor and Public service </p>
											<p>To facilitate the development of excellence in public service</p>
											<p>management ,promote efficient labor administration and provide</p>
											<p>sustainable social protection services for socio-economic transformation</p> 
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Ministry of labor Mashonaland East Province contact</h5>
								
								<p>Address : Marondera, Zimbabwe Box 523</p>
								<p>Email : <a href="">mlabor@jobs.com</a></p>
								<p>Phone : <a href="">0279-23562 /24084</a></p>
