				...
				<div class="container">
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
		                    ...
		                    $complogo = $row['avatar'];
		                    $comp = $row['member_no'];
                                $count = R::count('tbl_jobs','company=?',[$comp]);
							...
							<p class="mata-p clearfix"><span class="text-primary font700"><?php echo $count ;?></span> <span class="font13">Job post(s)</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right"></i></span></p>
							</div>
