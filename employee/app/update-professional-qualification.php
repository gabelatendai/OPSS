...
if ($certificate == "") {
$sql = "UPDATE tbl_professional_qualification SET town = '$town', institution = '$institution', title = '$course', timeframe = '$timeframe' WHERE id='$id' AND member_no = '$myid'";
...
$sql = "UPDATE tbl_professional_qualification SET town = '$town', institution = '$institution', title = '$course', timeframe = '$timeframe', certificate = '$certificate'  WHERE id='$id' AND member_no = '$myid'";
