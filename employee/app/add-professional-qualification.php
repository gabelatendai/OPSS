...
header("location:../qualifications.php?r=2290");
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_professional_qualification (member_no, institution, title, timeframe, certificate) VALUES (:memberno, :institution, :title, :timeframe, '$certificate')");
