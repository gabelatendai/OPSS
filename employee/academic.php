						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<option disabled value="">Select</option>
						            <?php
									$stmtb = $conn->prepare("SELECT * FROM tbl_town ORDER BY town_name");
                                    $stmtb->execute();
                                    $resultb = $stmtb->fetchAll();
                                    if($ctown) {
                                        foreach ($resultb as $rowb) {
                                            ?>
		                                    <option <?php if ($ctown == $rowb['town_name']) {
                                                print ' selected ';
                                            } ?> value="<?php echo $rowb['town_name']; ?>"><?php echo $rowb['town_name']; ?></option>
                                            <?php

                                        }
                                    }else {
                                        foreach ($resultb as $rowb) {
                                            ?> <option value="<?php echo $rowb['town_name']; ?>"><?php echo $rowb['town_name']; ?></option>
                                            <?php
                                        }
                                    }
								...
								?>
                                    ...
                                    {
										?>
										<option <?php if ($ctown == $rowb['town_name']) { print ' selected '; } ?> value="<?php echo $rowb['town_name']; ?>"><?php echo $rowb['town_name']; ?></option>
										<?php
